...
fun InfoContent(
    ...
    Box(
        ...
        LazyColumn(
            ...
            item { Spacer(modifier = Modifier.height(InfoLayout.TopAppBarPlaceholderHeight)) }
        ...
        CenterAlignedTopAppBar(
            ...
            colors = TopAppBarDefaults.topAppBarColors(
                containerColor = MaterialTheme.colorScheme.surface.copy(alpha = InfoLayout.TopAppBarAlpha),
